...
static class McpHost
{
    ...
    [
        ...
        ("push", "Preview with --check or publish to SVN with -m message. Existing allow-agent-push policy is enforced; MCP cannot grant it.", false),
        ...
        ("server-branch", "Copy an SVN server branch. arguments: name [--from checkout] [--dry-run] [--no-checkout] [-m message] [--keep external] [--as external=name].", false),
