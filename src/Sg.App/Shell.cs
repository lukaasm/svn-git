...
public static class Shell
{
    static readonly (string Key, string Label, string Action)[] Items =
    {
        ...
        ("04commit", "Commit... (the branch in a worktree, the server in a checkout)", "commit"),
        ("05shelf", "Shelved changes", "shelf"),
        ("06log", "Log (the branch in a worktree, the server in a checkout)", "log"),
        ("07rebase", "Rebase", "rebase"),
        ("08push", "Push to the server...", "push"),
